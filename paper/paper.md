...
The first app is `shinybisonpic`, a web-based app that allows users to upload and explore data by viewing camera locations and ratios of selected sex-age groups (e.g., Fig. 1). 
