...
Use the [`shinybisonpic` Shiny app](https://poissonconsulting.shinyapps.io/shinybisonpic-dev/) to explore the locations of camera traps and the the ratios of different classes of wood bison in camera trap observations.
...
See the ["Getting Started with bisonpictools"](https://poissonconsulting.github.io/bisonpictools/bisonpictools-getting-started.html) article for more detail.
